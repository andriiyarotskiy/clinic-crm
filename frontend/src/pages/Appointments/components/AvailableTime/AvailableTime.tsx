...
export const AvailableTime: React.FC<Props> = ({
  selectedDate,
  loading,
  handleAside,
  availableTime,
    ...
    <>
      <div className=" flex flex-col border border-[#E5E7EB] bg-[#FFFFFF] w-full h-[389px] rounded-[8px] px-[24px] py-[16px]">
        <div className="mb-[24px]">
          <h1 className="text-[14px] text-[#6B7280] font-semibold">
            ...
            <span className="text-[12px]">
              ...
              {selectedDoctorId && (
                <>
                  ...
                  <span className="text-[#B91C1C]">· {bookedCount} booked</span>
                </>
              )}
            </span>
          ) : (
        ...
        <div className=" flex justify-between mb-[32px]">
          <div className="flex h-[36px]">
            ...
            <BaseSelect
              error={
                !!selectedSpecialization && !!selectedDate && !selectedDoctorId
              }
